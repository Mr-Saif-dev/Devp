...
/**
 * Servlet implementation class Adminsinsert
 */
public class Adminsinsert extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		else
		{
			...
			RequestDispatcher rd = request.getRequestDispatcher("AdminSinsert.html");
			rd.include(request, response);
